...
class Controller:
    ...
    def _check_valid_move(self, start_pos: Position, direction: int):
    ...
    def handle_input(self, key: str):
        ...
        event, to_tile, from_pos , to_pos = self._check_valid_move(player_pos, key_to_direction[key])
        return event, to_tile, from_pos, to_pos
